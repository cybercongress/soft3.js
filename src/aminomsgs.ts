...
import { MsgDepositWithinBatch, MsgSwapWithinBatch, MsgWithdrawWithinBatch } from "./codec/tendermint/liquidity/v1beta1/tx";
...
export function createCyberTypes(): Record<string, AminoConverter> {
    return {
        ...
        "/tendermint.liquidity.v1beta1.MsgSwapWithinBatch": {
            ...
            fromAmino: ({ swapRequesterAddress,poolId,swapTypeId,offerCoin, demandCoinDenom, offerCoinFee, orderPrice }: AminoMsgSwapWithinBatch["value"]): MsgSwapWithinBatch => ({
                swapRequesterAddress: swapRequesterAddress,
        ...
        "/tendermint.liquidity.v1beta1.MsgDepositWithinBatch": {
            ...
            toAmino: ({ depositorAddress, poolId, depositCoins}: MsgDepositWithinBatch): AminoMsgDepositWithinBatch["value"] => {
            ...
            fromAmino: ({ depositorAddress, poolId, depositCoins}: AminoMsgDepositWithinBatch["value"]): MsgDepositWithinBatch => ({
                depositorAddress: depositorAddress,
                poolId: Long.fromString(poolId),
                depositCoins: depositCoins,
            }),
        ...
        "/tendermint.liquidity.v1beta1.MsgWithdrawWithinBatch": {
            ...
            toAmino: ({ withdrawerAddress, poolId, poolCoin}: MsgWithdrawWithinBatch): AminoMsgWithdrawWithinBatch["value"] => {
            ...
            fromAmino: ({ withdrawerAddress, poolId, poolCoin}: AminoMsgWithdrawWithinBatch["value"]): MsgWithdrawWithinBatch => ({
                withdrawerAddress: withdrawerAddress,
                poolId: Long.fromString(poolId),
                poolCoin: poolCoin,
            }),
