...
export class SigningCyberClient extends CyberClient {
  ...
  protected constructor(
    ...
    this.fees = buildFeeTable<CyberFeeTable>(gasPrice, defaultGasLimits, gasLimits);
  ...
  public async cyberlink(
    ...
    return this.signAndBroadcast(senderAddress, [cyberlinkMsg], this.fees.cyberlink, memo);
  }
  ...
  public async investmint(
    ...
    return this.signAndBroadcast(senderAddress, [investmintMsg], this.fees.investmint, memo);
  }
  ...
  public async createEnergyRoute(
    ...
    return this.signAndBroadcast(senderAddress, [createEnergyRouteMsg], this.fees.createRoute, memo);
  }
  ...
  public async editEnergyRoute(
    ...
    return this.signAndBroadcast(senderAddress, [editEnergyRouteMsg], this.fees.editRoute, memo);
  }
  ...
  public async deleteEnergyRoute(
    ...
    return this.signAndBroadcast(senderAddress, [deleteEnergyRouteMsg], this.fees.deleteRoute, memo);
  }
  ...
  public async editEnergyRouteAlias(
    ...
    return this.signAndBroadcast(senderAddress, [editEnergyRouteAliasMsg], this.fees.editRouteAlias, memo);
  }
  ...
  public async redelegateTokens(
    ...
    return this.signAndBroadcast(delegatorAddress, [redelegateMsg], this.fees.delegate, memo);
  }
  ...
  public async withdrawRewards(
    ...
    return this.signAndBroadcast(delegatorAddress, msgs, this.fees.withdraw, memo);
  }
